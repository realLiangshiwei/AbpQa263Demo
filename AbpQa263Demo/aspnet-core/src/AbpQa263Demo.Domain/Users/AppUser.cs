...
namespace AbpQa263Demo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpQa263DemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpQa263DemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
