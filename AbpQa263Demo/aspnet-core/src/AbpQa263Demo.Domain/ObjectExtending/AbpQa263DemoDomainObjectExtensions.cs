...
namespace AbpQa263Demo.ObjectExtending
{
    public static class AbpQa263DemoDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the AbpQa263DemoEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
